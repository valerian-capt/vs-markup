...
function reslice(){
	var set = jQuery('#footer .list-holder ul');
	...
	for(var i = 0, j = 0; i < item.length; i++){
		...
		str += ('<li>' + item.eq(i).html() + '</li>');
	}
	str += '</ul>';
	jQuery('#footer .list-holder').empty().html(str);
};